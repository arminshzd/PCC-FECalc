...
## Create box
gmx editconf -f complex.pdb -o complex_box.gro -c -bt cubic -box 6
## Solvate
...
5
EOF
    gmx grompp -f em.mdp -c complex_sol_ions.gro -p topol.top -o em.tpr
else
    gmx grompp -f em.mdp -c complex_sol.gro -p topol.top -o em.tpr
fi
